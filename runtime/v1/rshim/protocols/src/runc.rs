...
//! Generated file from `github.com/containerd/containerd/runtime/linux/runctypes/runc.proto`
...
pub struct RuncOptions {
    ...
    pub runtime_root: ::std::string::String,
...
impl<'a> ::std::default::Default for &'a RuncOptions {
    fn default() -> &'a RuncOptions {
        <RuncOptions as ::protobuf::Message>::default_instance()
    }
}

impl RuncOptions {
    pub fn new() -> RuncOptions {
    ...
    pub fn get_runtime_root(&self) -> &str {
        &self.runtime_root
    }
    pub fn clear_runtime_root(&mut self) {
        self.runtime_root.clear();
    }

    // Param is passed by value, moved
    pub fn set_runtime_root(&mut self, v: ::std::string::String) {
        self.runtime_root = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_runtime_root(&mut self) -> &mut ::std::string::String {
        &mut self.runtime_root
    }

    // Take field
    pub fn take_runtime_root(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.runtime_root, ::std::string::String::new())
    }
...
impl ::protobuf::Message for RuncOptions {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.runtime_root)?;
                },
                3 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.runtime_root.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.runtime_root);
        }
        if !self.criu_path.is_empty() {
            my_size += ::protobuf::rt::string_size(3, &self.criu_path);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.runtime_root.is_empty() {
            os.write_string(2, &self.runtime_root)?;
        }
        if !self.criu_path.is_empty() {
            os.write_string(3, &self.criu_path)?;
        }
        if self.systemd_cgroup != false {
            os.write_bool(4, self.systemd_cgroup)?;
        }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "runtime",
                |m: &RuncOptions| { &m.runtime },
                |m: &mut RuncOptions| { &mut m.runtime },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "runtime_root",
                |m: &RuncOptions| { &m.runtime_root },
                |m: &mut RuncOptions| { &mut m.runtime_root },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "criu_path",
                |m: &RuncOptions| { &m.criu_path },
                |m: &mut RuncOptions| { &mut m.criu_path },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "systemd_cgroup",
                |m: &RuncOptions| { &m.systemd_cgroup },
                |m: &mut RuncOptions| { &mut m.systemd_cgroup },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<RuncOptions>(
                "RuncOptions",
                fields,
    ...
    fn default_instance() -> &'static RuncOptions {
        static instance: ::protobuf::rt::LazyV2<RuncOptions> = ::protobuf::rt::LazyV2::INIT;
        instance.get(RuncOptions::new)
    }
}

impl ::protobuf::Clear for RuncOptions {
    fn clear(&mut self) {
        self.runtime.clear();
        self.runtime_root.clear();
        self.criu_path.clear();
...
impl ::std::fmt::Debug for RuncOptions {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for RuncOptions {
...
impl ::protobuf::Message for CreateOptions {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.shim_cgroup.is_empty() {
            my_size += ::protobuf::rt::string_size(9, &self.shim_cgroup);
        }
        if self.io_uid != 0 {
            my_size += ::protobuf::rt::value_size(10, self.io_uid, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.io_gid != 0 {
            my_size += ::protobuf::rt::value_size(11, self.io_gid, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.criu_work_path.is_empty() {
            my_size += ::protobuf::rt::string_size(12, &self.criu_work_path);
        }
        if !self.criu_image_path.is_empty() {
            my_size += ::protobuf::rt::string_size(13, &self.criu_image_path);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.no_new_keyring != false {
            os.write_bool(8, self.no_new_keyring)?;
        }
        if !self.shim_cgroup.is_empty() {
            os.write_string(9, &self.shim_cgroup)?;
        }
        if self.io_uid != 0 {
            os.write_uint32(10, self.io_uid)?;
        }
        if self.io_gid != 0 {
            os.write_uint32(11, self.io_gid)?;
        }
        if !self.criu_work_path.is_empty() {
            os.write_string(12, &self.criu_work_path)?;
        }
        if !self.criu_image_path.is_empty() {
            os.write_string(13, &self.criu_image_path)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "no_pivot_root",
                |m: &CreateOptions| { &m.no_pivot_root },
                |m: &mut CreateOptions| { &mut m.no_pivot_root },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "open_tcp",
                |m: &CreateOptions| { &m.open_tcp },
                |m: &mut CreateOptions| { &mut m.open_tcp },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "external_unix_sockets",
                |m: &CreateOptions| { &m.external_unix_sockets },
                |m: &mut CreateOptions| { &mut m.external_unix_sockets },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "terminal",
                |m: &CreateOptions| { &m.terminal },
                |m: &mut CreateOptions| { &mut m.terminal },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "file_locks",
                |m: &CreateOptions| { &m.file_locks },
                |m: &mut CreateOptions| { &mut m.file_locks },
            ));
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "empty_namespaces",
                |m: &CreateOptions| { &m.empty_namespaces },
                |m: &mut CreateOptions| { &mut m.empty_namespaces },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "cgroups_mode",
                |m: &CreateOptions| { &m.cgroups_mode },
                |m: &mut CreateOptions| { &mut m.cgroups_mode },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "no_new_keyring",
                |m: &CreateOptions| { &m.no_new_keyring },
                |m: &mut CreateOptions| { &mut m.no_new_keyring },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "shim_cgroup",
                |m: &CreateOptions| { &m.shim_cgroup },
                |m: &mut CreateOptions| { &mut m.shim_cgroup },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "io_uid",
                |m: &CreateOptions| { &m.io_uid },
                |m: &mut CreateOptions| { &mut m.io_uid },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "io_gid",
                |m: &CreateOptions| { &m.io_gid },
                |m: &mut CreateOptions| { &mut m.io_gid },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "criu_work_path",
                |m: &CreateOptions| { &m.criu_work_path },
                |m: &mut CreateOptions| { &mut m.criu_work_path },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "criu_image_path",
                |m: &CreateOptions| { &m.criu_image_path },
                |m: &mut CreateOptions| { &mut m.criu_image_path },
            ));
...
impl ::protobuf::Message for CheckpointOptions {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.work_path.is_empty() {
            my_size += ::protobuf::rt::string_size(8, &self.work_path);
        }
        if !self.image_path.is_empty() {
            my_size += ::protobuf::rt::string_size(9, &self.image_path);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.work_path.is_empty() {
            os.write_string(8, &self.work_path)?;
        }
        if !self.image_path.is_empty() {
            os.write_string(9, &self.image_path)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \nCgithub.com/containerd/containerd/runtime/linux/runctypes/runc.proto\
    \x12\x15containerd.linux.runc\"\x98\x01\n\x0bRuncOptions\x12\x1a\n\x07ru\
    ntime\x18\x01\x20\x01(\tR\x07runtimeB\0\x12#\n\x0cruntime_root\x18\x02\
    \x20\x01(\tR\x0bruntimeRootB\0\x12\x1d\n\tcriu_path\x18\x03\x20\x01(\tR\
    \x08criuPathB\0\x12'\n\x0esystemd_cgroup\x18\x04\x20\x01(\x08R\rsystemdC\
    groupB\0:\0\"\xea\x03\n\rCreateOptions\x12$\n\rno_pivot_root\x18\x01\x20\
    \x01(\x08R\x0bnoPivotRootB\0\x12\x1b\n\x08open_tcp\x18\x02\x20\x01(\x08R\
    ...
    \x0ccgroups_mode\x18\x07\x20\x01(\tR\x0bcgroupsModeB\0\x12&\n\x0eno_new_\
    keyring\x18\x08\x20\x01(\x08R\x0cnoNewKeyringB\0\x12!\n\x0bshim_cgroup\
    \x18\t\x20\x01(\tR\nshimCgroupB\0\x12\x17\n\x06io_uid\x18\n\x20\x01(\rR\
    \x05ioUidB\0\x12\x17\n\x06io_gid\x18\x0b\x20\x01(\rR\x05ioGidB\0\x12&\n\
    \x0ecriu_work_path\x18\x0c\x20\x01(\tR\x0ccriuWorkPathB\0\x12(\n\x0fcriu\
    _image_path\x18\r\x20\x01(\tR\rcriuImagePathB\0:\0\"\xcf\x02\n\x11Checkp\
    ointOptions\x12\x14\n\x04exit\x18\x01\x20\x01(\x08R\x04exitB\0\x12\x1b\n\
    \x08open_tcp\x18\x02\x20\x01(\x08R\x07openTcpB\0\x124\n\x15external_unix\
    _sockets\x18\x03\x20\x01(\x08R\x13externalUnixSocketsB\0\x12\x1c\n\x08te\
    rminal\x18\x04\x20\x01(\x08R\x08terminalB\0\x12\x1f\n\nfile_locks\x18\
    \x05\x20\x01(\x08R\tfileLocksB\0\x12+\n\x10empty_namespaces\x18\x06\x20\
    \x03(\tR\x0femptyNamespacesB\0\x12#\n\x0ccgroups_mode\x18\x07\x20\x01(\t\
    R\x0bcgroupsModeB\0\x12\x1d\n\twork_path\x18\x08\x20\x01(\tR\x08workPath\
    B\0\x12\x1f\n\nimage_path\x18\t\x20\x01(\tR\timagePathB\0:\0\"-\n\x0ePro\
    cessDetails\x12\x19\n\x07exec_id\x18\x01\x20\x01(\tR\x06execIdB\0:\0B\0b\
    \x06proto3\
";
